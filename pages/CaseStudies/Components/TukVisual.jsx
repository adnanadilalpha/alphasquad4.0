  ...
  return (
    <>
      <div className="item">
        ...
        <TextBox
          title="TUK"
          subTitle="Build captivating experiences with accessible, 
...
and fast track your workflow."
      ...
      <div className="item">
        <TextBox
          title="CONTEXT"
          subTitle="Tailwind UI Kit gives developers the functionality to 
...
and WCAG tested. Forget about building everything from scratch!"
        ...
        <TextBox
          ...
          subTitle="For TUK, we stuck with the dark gray and 
...
we chose to go with the inter typeface to make everything a tab bit ‘friendlier’. "
      ...
      <div className="item">
        ...
        <TextBox
          ...
          subTitle="There are a few websites that combines 
