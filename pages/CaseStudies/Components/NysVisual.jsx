  ...
  return (
    <>
      <div className="item">
        ...
        <TextBox
          title="THE NEW YOURK SUN"
          subTitle="The New York Sun is a 
...
Development, and DevOps. "
      ...
      <div className="item">
        <TextBox
          title="The Challenge"
          subTitle="The first challenge was 
...
scalability, and SEO optimization) and visual design."
      ...
      <div className="item">
        <TextBox
          title="Let’s Dive into The Process"
          subTitle="The design team worked closely 
...
process, we finally produced something that was exactly what they wanted."
      ...
      <div className="item">
        ...
        <TextBox
          ...
          subTitle="During the design phase, we noticed 
...
"
        ...
        <TextBox
          title="Sun Member & Founder Packages"
          subTitle='Through design and colors, a balance was
        ...
        <TextBox
          title="Annual & Montly Prices"
          subTitle="For the home we used 
