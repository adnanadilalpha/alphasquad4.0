...
<TextBox title="TOYOTA" subTitle="Toyota USA’s website is their 
...
<TextBox title="Context" subTitle="As a non-profit entity whose board 
...
<div className="item">
<TextBox title="The Process" subTitle="Our expert UX and backend team 
...
<div className="item">
<TextBox title="User Experience" subTitle="From there, we engaged Toyota in 
...
<TextBox title="Simple Navigation" subTitle={[
...
<TextBox title="Minimal Interface" subTitle={["At the same time, we had to appeal to younger users’ preference for a visual and intuitive UX that might overwhelm less tech-savvy users.",
...
<div className="item">
<TextBox title="Speed Optimization" subTitle="47% of customers expect a webpage to 
