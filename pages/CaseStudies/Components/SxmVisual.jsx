  ...
  return (
    <>
      ...
      <div className="item">
        <TextBox
          title="CONTEXT"
          subTitle="As a non-profit entity whose board includes 
...
and was rapidly losing ground to competitors due to the accrual of technical debt."
      ...
      <div className="item">
        <TextBox
          title="Solution"
          subTitle="Our team designed and developed an enrollment system 
...
"
        ...
        <TextBox
          key="1"
          title="Highlights of the system "
          ul={[
            <ul>
              <li>
                Designed and developed landing and enrollment pages to onboard
                the drivers into the system.
              </li>{" "}
              <br />
              <li>
                Provided an integrated enrollment system that is easy to use for
                the drivers to be onboarded.
              </li>{" "}
              <br />
              <li>
