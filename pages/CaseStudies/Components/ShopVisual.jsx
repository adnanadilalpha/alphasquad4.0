...
<TextBox title="SHOPLIFT" subTitle="Shoplift is an A/B Testing tool for Shopify merchants. It enables its users to 
...
<div className="item">
<Carousol img1="../Assets/shop2.webp" img2="../Assets/shops2.webp" img3="../Assets/shops3.webp"  interval="1500"/>
</div>

<div className="item">
<TextBox title="TYPOGRAPHY & COLORS" subTitle="For Shoplift, we stuck with the Black 
...
<div class="grid-rap">
    <div class="grid">
        <div class="cal-shop">
<div className="font">
<Carousol  img1="../Assets/font1.webp" img2="../Assets/font2.webp"  interval="500"/>
</div>
...
<img src="../Assets/access.png" alt="" />
        ...
        <div class="row-shop">
<div className="color">
<Carousol img1="../Assets/blue.webp" img2="../Assets/green.webp" img3="../Assets/orange.webp" img4="../Assets/red.webp"  interval="500"/>
</div>
<div className="pop">
<Carousol img1="../Assets/pop1.webp" img2="../Assets/pop2.webp" img3="../Assets/pop3.webp" interval="500"/>
</div>
        </div>
    </div>
</div>
...
<div className="item">
<TextBox title="The Dashboard" subTitle="The dashboard, after you connect 
...
<SwiperShop img1="../Assets/3.webp" img2="../Assets/5.webp" img3="../Assets/6.webp"/>

<TextBox title="The Brandkit" subTitle="Shoplift uses an API to pull in  your brand colors, 
