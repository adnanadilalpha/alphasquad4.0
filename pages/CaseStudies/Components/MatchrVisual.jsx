...
<>
<div className="item">
<Carousol img1="../Assets/ms1.webp" img2="../Assets/ms2.webp"  interval="1500"/>

<TextBox title="MATCHR" subTitle="Matchr makes it easy for HR professionals to find the top HR software programs 
...
<div className="item">
<TextBox title="TYPOGRAPHY & COLORS" subTitle="Though the brand colors remained the same, 
...
<div className="item">
<TextBox title="THE CHALLENGE" subTitle="There are a few websites that combines real estate with crypto, 
...
<TextBox title="MOBILE VIEW " subTitle="Here is the mobile view of matchr HRIS Software template. 
...
<TextBox title="THE METAVERSE VIEW" subTitle="There are a few websites that combines real estate with crypto, but there is none 
