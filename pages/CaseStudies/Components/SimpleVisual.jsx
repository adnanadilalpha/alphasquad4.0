  ...
  return (
    <>
      <div className="item">
        ...
        <TextBox
          title="SIMPLERO "
          subTitle="Simplero gives you all the tools you need to build and grow a successful 
...
required almost none of the UI but most of our UX Consultancy skills."
      ...
      <div className="item">
        ...
        <TextBox
          title="MOBILE VIEW "
          subTitle="Here is the mobile view of matchr HRIS Software template. The main challenge was 
