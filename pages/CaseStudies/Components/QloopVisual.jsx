...
<TextBox title="QLOOP " subTitle="QLoop is a web application that makes it simple for property owners to look at all the information of their properties, including tenants, agents, 
...
<div className="item">
<TextBox title="THE PROBLEM" subTitle="With so many properties between the landlords 
...
<TextBox title="DASHBOARD" subTitle="The dashboard gives users an overview of the total 
...
<TextBox title="CALCULATOR" subTitle="The calculator provides easy access and controls 
...
<TextBox title="A RESPONSIVE DESIGN" subTitle="The product is fully responsive on mobile devices, 
