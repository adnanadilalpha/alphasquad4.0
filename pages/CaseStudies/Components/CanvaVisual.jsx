  ...
  return (
    <>
      <div className="item">
        ...
        <TextBox
          title="CANVA"
          subTitle="Canva is a graphic design platform 
...
Canva Pro and Canva for Enterprise."
      ...
      <div className="item">
        ...
        <TextBox
          ...
          subTitle="For the overall visuals, we kept them very refreshing with elements 
...
their carbon print on planet Earth."
      ...
      <div className="item">
        <TextBox
          title="The Dashboard"
          subTitle="We designed a dashboard that 
...
most important."
        ...
        <TextBox
          ...
          subTitle="Added educational facts 
...
on the importance of minimizing carbon prints on the planet."
        ...
        <TextBox
          ...
          subTitle="We came up with a way to 
