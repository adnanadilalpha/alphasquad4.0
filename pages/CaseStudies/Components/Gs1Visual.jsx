...
printed on products that can be scanned electronically."
      ...
      <div className="item">
        <TextBox
          title="Solution"
          subTitle="Our team not only designed a solution for GS1 but 
...
into the CRM used by the client."
        ...
        <TextBox
          subTitle="The team also designed and developed several 
...
better lead management."
      ...
      <div className="item">
        <TextBox
          ...
          subTitle="The product is fully responsive 
