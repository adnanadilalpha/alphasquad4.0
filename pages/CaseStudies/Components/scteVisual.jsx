...
<div className="item">
<TextBox title="Context" subTitle="SCTE·ISBE is the leader in standards development for the cable industry. 
...
<ContentBox img="../Assets/cableco.webp" title="Re-imagining SCTE from the core up."/>
</div>

<div className="item">
<TextBox title="Complexities and skepticism" subTitle=" Due to both the complexity of the data manipulation required and the aging nature of its satellite systems, 
...
<TextBox title="foot in the door" subTitle={["The client elected to begin with a project that was somewhat narrow in  scope, but which required advanced calculation and algorithm  development capabilities.",
...
<TextBox  subTitle={["This broader initiative was intended to yield a dramatic change in the efficiency and perceived value of the client's business processes.",
...
<div className="item">
<TextBox title="A complete ecosystem" subTitle=" The most complicated and resource intensive project was the client's new website.
