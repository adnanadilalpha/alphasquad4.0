...
<TextBox title="LEARNFORCE PLATFORM " subTitle="GS1 is a neutral, not-for-profit, international organization 
...
<div className="item">
<TextBox title="PROBLEM STATEMENT" subTitle={["A digital content creation company out of the Netherlands reached out to our team to bring their idea of a digital learning platform to life. The necessity arose amidst the Covid-19 pandemic while educational institutions faced lockdowns. They wanted to tackle this by offering an online platform to the institutions where both staff and students can be easily onboarded and offered educational content.",
<br/>, <br/>,
...
<TextBox title="THIS IS WHAT WE CAME UP WITH" subTitle="The solution we designed was focused first and 
...
<TextBox title="COURSES TEMPLATE" subTitle="The underlying infrastructure provides enough 
...
<TextBox title="PROJECT highlights" subTitle={[<ul>
  <li>
  Designed a solution that scales
   in real-time to tackle elevated 
   loads at times and is then able 
   to scale down when the load 
   decreases resulting in lower
  infrastructure costs.
  </li> <br/> <br/>

  <li>
  Used AWS Cloudformation to host 
  multiple platforms under one application.
  </li> <br/> <br/>

  <li>
  Used serverless databases to host 
  and manage a massive dataset in 
  the most cost-effective way possible.
  </li> <br/> <br/>

  <li>
  Used Monorepo to manage the 
  codebase of the entire platform 
