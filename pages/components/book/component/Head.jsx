...
const Head = () => {
  ...
  return (
    <div className="flex flex-col xl:flex-row w-full h-full">
      <div
        className="relative overflow-hidden border-b sm:border-r  border-zinc-700 w-full xl:w-1/2"
        id="section2"
        onMouseMove={Hover1}
        onMouseOut={Hover1Leave}
      >
        <div className="light1" id="light1"></div>
        <div className="relative p-14 border-b border-r border-zinc-700 w-full xl:w-96">
          <Link href="/">
            <img src="../images/logoalpha.svg" alt="" className="logo" />
          </Link>
          ...
          <p className="text-zinc-400 text-base sm:text-lg xl:text-base text-center sm:text-left font-normal tracking-tight font">
            This is just so we can connect you with the specialist you’re
            looking for.
          </p>
        </div>
      ...
      <div
        className="relative overflow-hidden border-b xl:border-r  border-zinc-700 w-full xl:w-1/4"
        id="section3"
        onMouseMove={Hover2}
        onMouseOut={Hover2Leave}
      >
