...
const Team = (props) => {
  ...
  return (
    <>
      <div className="border w-full border-zinc-700 mb-12 sm:mb-12 xl:mb-32"></div>
      <div className="wrap-text-anima">
        ...
        <div className={focus} id="gif-1"></div>
        <div className={team}></div>
        <div className={result} id="gif-3"></div>
      </div>
    </>
  );
};
