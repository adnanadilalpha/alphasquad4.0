...
function Cutton() {
  ...
  return (
                <Link href="/dope">
                <p className="shiny tagline-4 text-center" onMouseMove={handleMouseMove} ref={buttonRef}>Dope stuff behind the box</p>
            </Link>
  );
}
  return (
...
<Link href="/CasePages/Scte">
    <div className="box-scte">
     ...
     <p className="description">
         More is more - 87% increase in conversion through UX optimization
     </p>
 </div>
 </Link>
</div>
...
<Link href="/CasePages/Nys">
    <div className="box-nys">
        ...
        <p className="description">
            The resurgence of a 200- year old, Pulitzer winning publication, in the digital era.
        </p>
</div>
</Link>
