    ...
    <>
      ...
      >
        <SwiperSlide>
          <div className="flex flex-col items-center gap-y-8">
            <p className="text-xl md:text-3xl text-neutral-400 font font-normal">
              “Easily, the best design and development studio we’ve worked with
        ...
        <SwiperSlide>
          <div className="flex flex-col items-center gap-y-8 font">
            <p className="text-xl md:text-3xl text-zinc-400 leading-10 font font-normal">
              “Excellent experience with AlphaSquad! they jumped right into the
              project, were exceptionally communicative, and offered suggestions
              improvements beyond the original "ask." They didn't need to ask
              many questions, worked crazy fast, and acted very empowered
        ...
        <SwiperSlide>
          <div className="flex flex-col items-center gap-y-8 font">
            <p className="text-xl md:text-3xl text-zinc-400 font font-normal">
              “Loved working with AlphaSquad. Great leaders and skilled
        ...
        <SwiperSlide>
          <div className="flex flex-col items-center gap-y-8 font">
            <p className="text-xl md:text-3xl text-zinc-400 font font-normal">
              “AlphaSquad is amazing ! I highly recommend using them as they did
              an amazing job on my UX/UI design.. I will be back”
            </p>
            <div className="w-2/4 border border-zinc-400 h-0"></div>
            <p className="text-base text-zinc-400 font">
