...
const Footer = () => {
  return (
<div className="flex flex-col justify-between md:flex  2xl:flex  xl:flex-row 2xl:mt-24 mb-9 mx-6 2xl:mx-20 font ">
...
<div className="flex flex-col items-center md:flex md:flex-row md:justify-between gap-x-0 md:gap-x-28">
         <div className='mb-8 text-center sm:text-left'>
         <p className="text-neutral-400 text-sm sm:text-2xl font font-light">
        ...
        <div className="w-auto md:w-80 text-right font">
            <p className="text-neutral-400 text-xs sm:text-2xl font-light ">© ALPHASQUAD LLC 2022
