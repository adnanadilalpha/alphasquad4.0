  ...
  return (
    <div className="flex flex-col justify-between md:flex  2xl:flex  xl:flex-row 2xl:mt-24 mt-8 mb-9 mx-6 2xl:mx-20 font ">
      <div className="flex flex-col items-center md:items-start">
        <span className="text-base xl:mb-4 sm:text-2xl text-zinc-400">FIND ME</span>
        <ul className="sm:mb-4 flex items-center gap-x-2 text-white text-sm sm:text-lg font font-light">
      ...
      <div className="flex flex-col md:flex md:flex-row md:justify-between gap-x-0 xl:gap-x-28 2xl:gap-x-72">
        <div className="text-center md:text-left">
          <p className="text-zinc-400 xl:mb-4 text-sm sm:text-2xl font font-light w-full">
        ...
        <div className="flex justify-center xl:items-end md:w-96 text-right font w-full">
